...
void panels::DrawTools(ToolsState& state) {
    ...
    struct {
        ...
        {ICON_FA_PAINTBRUSH "##t0", "Brush  (B)"}, {ICON_FA_ERASER "##t1", "Eraser  (E)"},
        {ICON_FA_FILL_DRIP "##t2", "Fill  (F)"},   {ICON_FA_PEN "##t3", "Line  (L)"},
        {ICON_FA_SQUARE "##t4", "Rect  (R)"},      {ICON_FA_CIRCLE "##t5", "Circle  (C)"},
